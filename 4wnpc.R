data_nu <- read.csv("C:/Users/eddie/Desktop/4W_plots_sept.csv")
...
data_nu$Sample.Name <- factor(data_nu$Sample.Name, levels = c("H9", "NCRM1", "KYOU", "AIW002-02", "AJC001-5", "AJG001-C4", "TD02", "3448", "3450", "AJD002-3", "TD03","TD10",  "TD22"))
...
for (val in c("AFP","ASCL1","S100B","STAB2")) {
